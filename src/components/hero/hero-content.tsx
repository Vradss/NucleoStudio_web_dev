...
export function HeroContent() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mx-auto font-geist-black text-[38px] leading-tight sm:text-5xl lg:text-[75px] whitespace-pre-line"
      ...
      <motion.p
        className="mx-auto max-w-5xl font-geist-regular text-[16px] text-nucleo-light sm:text-xl lg:text-[22px]"
        variants={itemVariants}
      >
